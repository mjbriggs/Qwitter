...
public class UnFollow implements IProxy
{
        ...
        public UnFollow(String loggedUser, String userToFollow, String authToken)
        {
            mLoggedUser = loggedUser;
            mUserToUnFollow = userToFollow;
            mUrl = Global.BASE_URL + "unfollow";
        ...
        public void execute()
        {
            try
            {
                String reqBody = "{\n" +
                        ...
                        "\"userToUnFollow\":\"" + mUserToUnFollow + "\"\n" +
                        "}";
